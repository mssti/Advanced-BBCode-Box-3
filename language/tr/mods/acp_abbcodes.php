...
$lang = array_merge($lang, array(
	'ACP_ABBCODES'						=> 'Advanced BBcodes Box 3',
	'ACP_ABBCODES_EXPLAIN'				=> 'Buradan <strong>[ <a href="http://www.mssti.com/phpbb3" target="_blank">ABBC3</a> ]</strong> için uygun temaları yönetebilirsiniz.<br />Uyarlanmış temaları aktif pasif hale getirebilirsiniz. Aynı zamanda buradan temalarınıza ait ABBCB3 önizlemelerini görüntüleyebilirsiniz. <br /><em><b>(*)</b> ile işaretlenmiş tema mvarsayılan temanızdır. Aynı zamanda her bir temaya ait toplam kullanıcı sayısını da görüntüleyebilirsiniz.</em>',

	'ABBCODES_DISABLE'					=> 'ABBC3',
	'ABBCODES_DISABLE_EXPLAIN'			=> '<strong>Advanced BBodes Box 3</strong> eklentisini kullanıcılar ve/veya standart mesaj gönderim sayfasında etkin veya pasif yapabilirsiniz.',
	'ABBCODES_BG'						=> 'Artalan resmi',
	'ABBCODES_BG_EXPLAIN'				=> 'This will set the back ground image for icons.<br />Set to <em>no image</em> for fit to your style.',
	'ABBCODES_TAB'						=> 'Etiketler için ayraç kullan',
	'ABBCODES_BOXRESIZE'				=> 'Mesaj yazım alanını yeniden boyutlandır.',
	'ABBCODES_BOXRESIZE_EXPLAIN'		=> 'Mesaj yazım alanındaki yeniden boyutlandırma resmini göster.',
	...
	'ABBCODES_JAVASCRIPT_EXPLAIN'		=> '<strong>Not : </strong> <em>AdvancedBox JS</em> resimleri göstermeye yarayan bir javascripttir.<br /><em>contrib</em> klasöründe <strong>ABBC3</strong>\'un Highslide JS | LiteBox | GreyBox ile nasıl kullanılabileceğine dair ayrıntıları bulabilirsiniz.',
	...
	'ABBCODES_RESIZE_METHODS'			=> array( 'AdvancedBox' => 'AdvancedBox JS', 'enlarge' => 'büyüt', 'samewindow' => 'aynı pencerede', 'newwindow' => 'yeni pencerede', 'none' => 'yeniden boyutlandırma'),
