<?php
/**
* @package: phpBB 3.0.7-PL1 :: Advanced BBCode box 3 -> root/includes
	...
	**/
	function abbcode_init()
	{
		...
		$this->abbcode_config = array(
			'ABBC3_VERSION'			=> (isset($config['ABBC3_VERSION'])) ? $config['ABBC3_VERSION'] : '3.0.7-PL1' ,
			// Display ABBC3 ?
