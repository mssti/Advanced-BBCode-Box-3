...
var litebox_version = 0.000008; // 0.0.B8

var litebox_alt			= "Image";
var litebox_zoomImg		= "./styles/litebox/spacer.gif";
var litebox_zoomStyle	= "width: 20px; height: 20px; background: url(./styles/litebox/icon_reimg_zoom_in.gif) top left no-repeat; filter: Alpha(Opacity=50); opacity: .50;";
...
var litebox_closeImg	= "./styles/litebox/spacer.gif";
var litebox_closeStyle	= "width: 20px; height: 20px; background: url(./styles/litebox/icon_reimg_zoom_out.gif) top left no-repeat; filter: Alpha(Opacity=50); opacity: .50;";
...
// calling the litebox_show() function:
//
