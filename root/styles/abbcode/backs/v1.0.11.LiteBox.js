...
NcodeImageResizer.prototype.createWarning = function()
{
	...
	this.img.setAttribute('rel', 'lightbox');
			...
			case 'hoverbox resize_me':
				switch (ImageResizerMode)
				{
					case 'AdvancedBox':
						...
						img.onclick = function () {myLightbox.start(this);}
						break;
					case 'enlarge':
			...
			case 'attach_parent':
				...
				switch (ImageResizerMode)
				{
					case 'AdvancedBox':
						if ( !ImageResizer  )
						{
							img.parentNode.setAttribute('rel', 'lightbox');
							img.parentNode.onclick = function () { myLightbox.start(this); return false; }
						}
						break;
					case 'enlarge':
						if ( !ImageResizer )
			...
			case 'attach_me':
				...
				switch (ImageResizerMode)
				{
					case 'AdvancedBox':
						...
						{
							img.setAttribute('rel', 'lightbox');
							img.onclick = function () { myLightbox.start(this); return false; }
						}
						break;
					case 'enlarge':
						if ( !ImageResizer )
