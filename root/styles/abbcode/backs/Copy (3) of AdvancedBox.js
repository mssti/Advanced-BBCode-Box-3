...
//	/** zb_style styles **/
//	if ( document.getElementById("page-body2") )
//	{
//		posted_images_ary = document.getElementById("page-body2").getElementsByTagName("img");
//	}
//	/** stargate portal **/
//	if ( document.getElementById("center") )
//	{
//		posted_images_ary = document.getElementById("center").getElementsByTagName("img");
//	}

//	/** board3  portal **/
//	if ( document.getElementById("main-right") )
//	{
//		posted_images_ary = document.getElementById("main-right").getElementsByTagName("img");
//	}

//	/** Ajax chat 2.0.8B **/
//	if ( document.getElementById("chat") )
//	{
//		posted_images_ary = document.getElementById("chat").getElementsByTagName("img");
//	}
