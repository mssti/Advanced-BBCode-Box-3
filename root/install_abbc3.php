...
//	                             'bbcode_tag', 'bbcode_order', 'bbcode_id', 'bbcode_helpline', 'bbcode_match', 'bbcode_tpl', 'first_pass_match', 'first_pass_replace', 'second_pass_match', 'second_pass_replace', 'display_on_posting', 'display_on_pm', 'display_on_sig', 'abbcode', 'bbcode_image', 'bbcode_group'; 
		...
		'upload'		=> array("upload",			53,	0,	"ABBC3_UPLOAD_MOVER",	 ".", ".", ".", ".", ".", ".", 1, 0, 0, 1, "upload.gif", "5, 4"),
		'anchor'		=> array("anchor=",			54,	1,	"ABBC3_ANCHOR",			 "[anchor{TEXT1}]{TEXT2}[/anchor]", "<a id=\"{TEXT1}\">{TEXT2}</a>", "!\[anchor\=(.*?)(\s+|)?(.*?)\](.*?)\[/anchor\]!ies", '\'[anchor=${1}${2}${3}:$uid]\'.str_replace(array("\r\n", \'\"\', \'\\\'\', \'(\', \')\'), array("\n", \'"\', \'&#39;\', \'&#40;\', \'&#41;\'), trim(\'${4}\')).\'[/anchor:$uid]\'', '!\[anchor\=(.*?)((\s+)(goto\=|)?(.*?))?:$uid\](.*?)\[/anchor:$uid\]!ies', '$this->anchor_pass(\'$1\',\'$5\', \'$6\')', 1, 1, 1, 1, "anchor.gif"),
		'url'			=> array("url",				55,	0,	"ABBC3_URL_TIP",		 ".", ".", ".", ".", ".", ".", 1, 1, 1, 1, "url.gif"),
		...
		'testlink'		=> array("testlink",		63, 1,	"ABBC3_TESTLINK_TIP",	 "[testlink]{TEXT}[/testlink]", "<a src=\"{TEXT}\">{TEXT}</a>", "!\[testlink\](.*?)\[/testlink\]!ies", '\'[testlink:$uid]${1}[/testlink:$uid]\'', '!\[testlink:$uid\](.*?)\[/testlink:$uid\]!ies', '$this->testlink_pass(\'$1\')', 0, 0, 0, 1, "testlink.gif"),
		'click'			=> array("click",			64, 1,	"ABBC3_CLICK_TIP",		 "[click{URL}]{URL}[/click]", "<a src=\"{URL}\">{URL}</a>", "!\[click(\\=(.*?))?\](.*?)\[/click\]!ies", '\'[click${1}:$uid]${3}[/click:$uid]\'', '!\[click(\\=(.*?))?:$uid\](.*?)\[/click:$uid\]!ies', '$this->click_pass(\'$2\', \'$3\')', 0, 0, 0, 1, "click.gif"),
		'search'		=> array("search",			65, 1,	"ABBC3_SEARCH_TIP",		 "[search{TEXT1}]{TEXT2}[/search]", "<a src=\"{TEXT1}\">{TEXT2}</a>", "!\[search(\\=(msn|msnlive|yahoo|google|altavista|lycos|wikipedia))?\](.*?)\[/search\]!ies", '\'[search${1}:$uid]\'.str_replace(array("\r\n", \'\"\', \'\\\'\', \'(\', \')\'), array("\n", \'"\', \'&#39;\', \'&#40;\', \'&#41;\'), trim(\'${3}\')).\'[/search:$uid]\'', '!\[search(\\=(.*?))?:$uid\](.*?)\[/search:$uid\]!ies', '$this->search_pass(\'$1\', \'$2\', \'$3\')', 1, 1, 1, 1, "search.gif"),
