...
// Help page
	...
	'ABBC3_HELP_WRITE'			=> 'O seu formato de escrita',
	'ABBC3_HELP_VIEW'			=> 'O nosso formato de apresentação',
...
// Image Resizer JS
	...
	'ABBC3_RESIZE_FULLSIZE'		=> 'Imagem redimensionada para : %1$s % do seu tamanho original [ %2$s x %3$s ]',
...
// Text to be applied to the helpline & mouseover & help page & Wizard texts
    ...
    'ABBC3_UNAUTHORISED'		=> 'Não pode utilizar determinadas palavras : <br /><strong> %s </strong>',
	'SAMPLE_TEXT'				=> 'Este texto é um exemplo.' //	' . $lang['SAMPLE_TEXT'] . '
));
...
// bbcodes texts	
	...
	'ABBC3_FONT_WIN'			=> 'Padrões do windows',
	...
	'ABBC3_HIGHLIGHT_NOTE'		=> 'Observação: Pode usar cores em html (color=#FF0000 ou color=red)',
...
##	For translate :                                        yes
	'ABBC3_QUOTE_VIEW'			=> '<blockquote><div><cite>Utilizador '. $lang['WROTE'] .':</cite>' . $lang['SAMPLE_TEXT'] . '</div></blockquote>',
...
##	For translate :                                                                                                                               yes                                                      yes               yes
	'ABBC3_SPOIL_VIEW'			=> '<div class="spoilwrapper"><div class="spoiltitle"><input id="1" class="btnspoil button2" type="button" value="Mostrar Spoiler" onClick="javascript:abbc3_spoiler( 2, 2, \'Esconder Spoiler\', \'Mostrar Spoiler\' )"></div><div class="spoilcontent"><div id="2" style="display: none;">' . $lang['SAMPLE_TEXT'] . '</div></div></div>',
...
##	For translate :                                                                                                                                                                               yes
	'ABBC3_MOD_VIEW'			=> '<table class="ModTable" width="100%" cellspacing="5" cellpadding="0" border="0"><tr><td class="exclamation" rowspan="2">&nbsp;!&nbsp;</td><td class="rowuser">Nome do moderador '. $lang['WROTE'] .':</td></tr><tr><td class="rowtext">' . $lang['SAMPLE_TEXT'] . '</td></tr></table>',
...
##	For translate :                                                                yes
	...
	// NFO
	'ABBC3_NFO_TITLE'			=> 'Texto Informativo (NFO)',
	...
	'ABBC3_ALIGNJUSTIFY_VIEW'	=> '<div style="text-align:justify">Este texto é <br />um exemplo</div>',
...
##	For translate :                 yes                                                                 yes
	'ABBC3_SUP_VIEW'			=> 'Este é um texto <sup>' . $lang['SAMPLE_TEXT'] . '</sup> este é um texto normal',
	
	// Subscript
	'ABBC3_SUB_MOVER'			=> 'Texto Subscrito',
	'ABBC3_SUB_TIP'				=> '[sub]texto[/sub]',
##	For translate :                 yes                                                                 yes
	'ABBC3_SUB_VIEW'			=> 'Este é um texto <sub>' . $lang['SAMPLE_TEXT'] . '</sub> este é um texto normal',
	...
	'ABBC3_GRAD_COLORS'			=> 'Cores pré-seleccionadas',
...
##	For translate :                         yes           yes           yes                   yes              yes              yes                yes
	'ABBC3_LISTB_VIEW'			=> '<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul><br /> ou <br /><ul><li>Item disco<ul><li>Item circulo<ul><li>item quadrado</li></ul></li></ul></li></ul><br />',
...
##	For translate :                                                                  yes          yes           yes             yes                                                   yes           yes           yes             yes                                                   yes            yes            yes              yes                                                   yes            yes             yes                yes                                                   yes            yes             yes
	'ABBC3_LISTO_VIEW'			=> '<ol style="list-style-type: arabic-numbers"><li>Item 1</li><li>Item 2</li><li>Item 3</li></ol> ou <br /><ol style="list-style-type: lower-alpha"><li>Item 1</li><li>Item 2</li><li>Item 3</li></ol> ou <br /><ol style="list-style-type: upper-alpha"><li>item A</li><li>item B</li><li>item C</li></ol> ou <br /><ol style="list-style-type: lower-roman"><li>Item i</li><li>Item ii</li><li>Item iii</li></ol> ou <br /><ol style="list-style-type: upper-roman"><li>Item I</li><li>Item II</li><li>Item III</li></ol>',
    ...
    'ABBC3_ED2K_FRIEND'			=> 'amigo ed2k',
	'ABBC3_ED2K_SERVER'			=> 'servidor ed2k',
	'ABBC3_ED2K_SERVERLIST'		=> 'lista de servidores ed2k',
	...
	// Rapid share checker
	'ABBC3_FOPEN_ERROR'			=> '<strong>Erro : </strong> Pedimos desculpa mas aparentemente a função <strong>allow_url_fopen</strong> está desactivada, esta função requere que a directiva PHP allow_url_fopen esteja activada.',
	...
	'ABBC3_LOGIN_EXPLAIN_VIEW'	=> 'Este forum requere que esteja registado e ligado para poder ver os links.',
	...
	'ABBC3_CLICK_ERROR'			=> '<strong>ERRO:</strong> Por favor introduza um click ID V�?LIDO no URL',
...
//	'ABBC3_STAGE6_VIEW'			=> '<object  classid="clsid:67DABFBF-D0AB-41fa-9C46-CC0F21721616" codebase="http://download.divx.com/player/DivXBrowserPlugin.cab" width="200" height="100" ><param name="src" value="http://video.stage6.com/2068715/.divx" /><param name="autoplay" value="false" /><param name="custommode" value="Stage6" /><param name="showpostplaybackad" value="false" /><embed type="video/divx" src="http://video.stage6.com/2068715/.divx" pluginspage="http://go.divx.com/plugin/download/" showpostplaybackad="false" custommode="Stage6" autoplay="false" width="200" height="100" /></object><br />',
	...
	// Dailymotion video
	'ABBC3_DM_MOVER'			=> 'Inserir vídeo do dailymotion', // de http://www.dailymotion.com/
