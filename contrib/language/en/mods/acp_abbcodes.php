...
$lang = array_merge($lang, array(
	...
	'ABBCODES_JAVASCRIPT_EXPLAIN'		=> '<strong>Note : </strong> <em>AdvancedBox JS</em> is an JavaScript software used to display images in full size.<br />In <em>contrib</em> folder you will find how to use <strong>ABBC3</strong> with other\'s script.<br />This modifications are totally optionals. Each script have his own support. I\'m not responsible about it. I will not answer question/problem/bug or any kind of issues about them.',
...
##	For translate :                                Don't            Yes               Don't        Yes             Don't        Yes        Don't           yes            Don't          yes           Don't     yes
	...
	'ABBCODES_UPLOAD_EXTENSION_EXPLAIN'	=> 'Puede añadir/modificar/eliminar formatos permitidos. Separe las extensiones con una coma(,)<br /><strong>Note : </strong> These values will overwrite the Attachments Manage extensions setings.',
));
...
$lang = array_merge($lang, array(
	...
	'INSTALLER_INSTALL_END'				=> 'Installation of <strong>%1$s version : %2$s</strong> was successful. <br /> <p>You should now <a href="../index.php">login to your board</a> and check if everything is working fine. <br />Do not forget to delete, rename or move your <strong>install_abbc3</strong> directory!</p>',
