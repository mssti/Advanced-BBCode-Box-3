...
function ImageResizerOn( ObjImage )
{
	...
	if ( ImageResizerMode == 'AdvancedBox' ) { ObjImage.setAttribute('rel', 'lightbox'); }
}
	...
	for (var pia = 0; pia < posted_images_ary.length; pia++)
	{
		...
		switch ( img.className )
		{
			...
			case 'hoverbox resize_me':
				...
				{
					case 'AdvancedBox':
						img.setAttribute('rel', 'lightbox'); img.onclick = function () {myLightbox.start(this);}
						break;
					case 'enlarge':
			...
			case 'attach_parent':
				...
				{
					case 'AdvancedBox':
						if ( !ImageResizer ) { img.parentNode.setAttribute('rel', 'lightbox'); img.parentNode.onclick = function () { myLightbox.start(this); return false; } }
						break;
					case 'enlarge':
			...
			case 'attach_me':
				...
				{
					case 'AdvancedBox':
						if ( !ImageResizer ) { img.setAttribute('rel', 'lightbox'); img.onclick = function () { myLightbox.start(this); return false; } }
						break;
					case 'enlarge':
