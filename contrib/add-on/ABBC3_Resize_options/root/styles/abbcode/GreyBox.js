...
//		objResizerText.data		= 'Image resized to : ' + ResizerP + '% of its original size [ ' + ResizerW + ' x ' + ResizerH + ' ]';
	...
	if ( ImageResizerMode == 'AdvancedBox' ) { ObjImage.rel = "gb_imageset[]"; }
}
	...
	for (var pia = 0; pia < posted_images_ary.length; pia++)
	{
		...
		switch ( img.className )
		{
			...
			case 'hoverbox resize_me':
				...
				{
					case 'AdvancedBox':
						img.rel = "gb_imageset[]"; img.onclick = function () {GB_showImage(this.src,this.src);}
						break;
					case 'enlarge':
			...
			case 'attach_parent':
				...
				{
					case 'AdvancedBox':
						if ( !ImageResizer ) { img.parentNode.rel = "gb_imageset[]"; img.parentNode.onclick = function () {GB_showImage(this.href,this.href); return false; } }
						break;
					case 'enlarge':
			...
			case 'attach_me':
				...
				{
					case 'AdvancedBox':
						if ( !ImageResizer ) { img.rel = "gb_imageset[]"; img.onclick = function () {GB_showImage(this.src,this.src);} }
						break;
					case 'enlarge':
